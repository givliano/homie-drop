export function LinkShare({ active, onClick }) {
  ...
  return (
    <div className={`link-share ${active ? 'active' : ''}`}>
      <div className="link-share--wrapper">
        <span className="link-text">Copy URL</span>
        <button className='link url' onClick={() => handleUrlShareClick()}>
      ...
      <div className="link-share--wrapper">
        ...
        <button className='link qrcode' onClick={onClick}>
          <svg xmlns='http://www.w3.org/2000/svg' height='48' width='48'>
